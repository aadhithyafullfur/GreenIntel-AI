        ...
        <div className="flex items-start justify-between gap-3 mb-3 z-10 shrink-0">
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-sm font-bold text-text-main tracking-tight flex items-center gap-1.5">
                {title}
              </h3>
              {infoTooltip && (
                  ...
                  <AnimatePresence>
                    {showInfo && (
                      <motion.div
                        ...
                        exit={{ opacity: 0, y: 4 }}
                        className="absolute left-0 bottom-full mb-1.5 w-56 p-2 bg-neutral-900 text-white dark:bg-neutral-100 dark:text-neutral-900 text-[11px] font-medium rounded-lg shadow-xl z-30 pointer-events-none"
                      >
                        {infoTooltip}
                      </motion.div>
                    )}
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-1.5 text-text-muted hover:text-text-main bg-neutral-100 hover:bg-neutral-200 dark:bg-white/5 dark:hover:bg-white/10 rounded-lg border border-black/5 dark:border-white/10 transition-colors cursor-pointer"
